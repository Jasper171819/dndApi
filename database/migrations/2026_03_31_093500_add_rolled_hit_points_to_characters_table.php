...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('characters', function (Blueprint $table): void {
            $table->integer('hp_adjustment')->default(0)->after('charisma');
            $table->boolean('rolled_hit_points')->default(false)->after('hp_adjustment');
        });
    }
    ...
    {
        Schema::table('characters', function (Blueprint $table): void {
            $table->dropColumn(['hp_adjustment', 'rolled_hit_points']);
        });
    }
};
